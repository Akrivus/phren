...
class MemoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memory" do
    assert_difference("Memory.count") do
      post memories_url, params: { memory: { chat_id: @memory.chat_id, content: @memory.content, embedding: @memory.embedding, prompt_id: @memory.prompt_id } }
    end
  ...
  test "should update memory" do
    patch memory_url(@memory), params: { memory: { chat_id: @memory.chat_id, content: @memory.content, embedding: @memory.embedding, prompt_id: @memory.prompt_id } }
